...
the package author (Joshua N. Pritikin) for the LMP
item model.
...
(e.g., [OpenMx](http://openmx.psyc.virginia.edu/))

# Procedure

## Outline

Obtain rpf source code from [CRAN](https://cran.r-project.org/web/packages/rpf/index.html)
...
on Schilling & Bock (2005), equations 22 and 23 for
...
Note also that the top of file ought to have documentation
...
Falk and Cai (in press, *Psychometrika*).
...
For latent traits, with cheap ways of testing
